...
static int default_glo_frq_table[32] = { 1, -4, 05, 06, 01, -4, 05, 06, -2, -7, 00, -1, -2, -7, 00, -1, 04, -3, 03, 02, 04, -3, 03, 02, 0, -5, -99, -99, -99, -99, -99, -99 };
                         ...
                         const int *ex, const int *half)
{
    ...
    for (i=j=0;i<h->nsat;i++) {
        ...
        if (sys==SYS_GLO) {
            ...
            else if (default_glo_frq_table[prn-1]!=-99) {
